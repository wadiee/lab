...
import re
#function getResultWindow(vm, DateVal, LibNum, RoomID, pointer, ReserveID, ActionVal, Range)
#href="javascript:getResultWindow('d','',9999,36,'','',0,-1);
#                       UrlPath = "roomrequest.asp?command=getResultWin&vm=" + vm 
#                       + "&res=" + ReserveID + "&SelectedDate=" + DateVal + "&room=" 
#                       + RoomID + "&pointer=" + pointer + "&rowchange=&entitytype=0&
#                       LangType=0&mm=1&timestamp="+ new Date().getTime();
